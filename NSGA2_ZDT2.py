...
def mutation(solution):
    ...
    mu_solution=mutPolynomialBounded(solution, 30, min_x, max_x, mutation_prob)
    # if mutation_prob <1:
...
for j in range(0,pop_size):
    solution = [min_x + (max_x - min_x) * random.random() for i in range(0, 30)]
...
plt.title("first population of ZDT2")
plt.figure()
